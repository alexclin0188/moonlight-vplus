...
object QuickActionRegistry {
    ...
    private val BUILTIN = linkedMapOf(
        ...
        "toggle_audio" to QuickAction("toggle_audio", "Audio",   R.drawable.ic_audio_settings, R.drawable.ic_audio_settings_disabled, R.string.qa_label_audio),
        "send_sleep"  to QuickAction("send_sleep",  "Sleep",   R.drawable.ic_btn_sleep, 0, R.string.action_sleep),
        "send_win"    to QuickAction("send_win",    "WIN",     R.drawable.ic_btn_win),
        "send_esc"    to QuickAction("send_esc",    "ESC",     R.drawable.ic_btn_esc),
        "toggle_mic"  to QuickAction("toggle_mic",  "Mic",     R.drawable.ic_mic_gm, R.drawable.ic_mic_gm_disabled, R.string.qa_label_mic),
        // ── 扩展内置动作 ──
