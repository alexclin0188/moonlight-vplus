 ...
 *
 * 注意：此函数使用旧的 [StreamEngine.controllerManager]，该管理器在 MoonLink 架构中为 null。
 * 新架构请使用 [syncConfigToEngine]。
 */
@Deprecated("使用 syncConfigToEngine 替代")
fun syncToControllers(
    engine: StreamEngine,
